...
class IQxel():
    ...
    def read_data(self, target_power):
        ...
        self.__log__(log_switch, rlevel)
...
class dut():
    ...
    def tx(self, mode, channel, bw, rate, chain):
        ...
        time.sleep(3)
        self.tn.read_until(b'#ONT/system/shell>', timeout=8)
...
if __name__ == '__main__':
    ...
    for rows in dut_file:
        if rows[0] == 'DUT_IP':
            ...
            add4 = rows[1]
            print('Addition Parameters: ', add4)
    ...
    target_pwr_VHT20_MCS0, target_pwr_VHT20_MCS1, target_pwr_VHT20_MCS2, target_pwr_VHT20_MCS3, target_pwr_VHT20_MCS4, \
    target_pwr_VHT20_MCS5, target_pwr_VHT20_MCS6, target_pwr_VHT20_MCS7, target_pwr_VHT20_MCS8, target_pwr_VHT40_MCS0, \
    target_pwr_VHT40_MCS1, target_pwr_VHT40_MCS2, target_pwr_VHT40_MCS3, target_pwr_VHT40_MCS4, target_pwr_VHT40_MCS5, \
    target_pwr_VHT40_MCS6, target_pwr_VHT40_MCS7, target_pwr_VHT40_MCS8, target_pwr_VHT40_MCS9, target_pwr_VHT80_MCS0, \
    target_pwr_VHT80_MCS1, target_pwr_VHT80_MCS2, target_pwr_VHT80_MCS3, target_pwr_VHT80_MCS4, target_pwr_VHT80_MCS5, \
    target_pwr_VHT80_MCS6, target_pwr_VHT80_MCS7, target_pwr_VHT80_MCS8, target_pwr_VHT80_MCS9 = [None] * 57
    ...
    target_VHT80_MCS6_EVM, target_VHT80_MCS7_EVM, target_VHT80_MCS8_EVM, target_VHT80_MCS9_EVM = [None] * 57
    ...
    for line in f.readlines():
        ...
        if len(line) < 3 or line.startswith('//'):
            ...
            if int(channel) < 5000:
                ...
                for r in range(sheet_2g.max_row):
                   ...
                   ratelist_5g = ['6M', '9M', '12M', '18M', '24M', '36M', '48M', '54M', 'HT20_MCS0', 'HT20_MCS1',
                                  'HT20_MCS2',
                                  'HT20_MCS3', 'HT20_MCS4', 'HT20_MCS5', 'HT20_MCS6', 'HT20_MCS7', 'HT40_MCS0',
                                  'HT40_MCS1',
                                  'HT40_MCS2', 'HT40_MCS3', 'HT40_MCS4', 'HT40_MCS5', 'HT40_MCS6', 'HT40_MCS7',
                                  'VHT20_MCS0',
                                  'VHT20_MCS1', 'VHT20_MCS2', 'VHT20_MCS3', 'VHT20_MCS4', 'VHT20_MCS5', 'VHT20_MCS6',
                                  'VHT20_MCS7',
                                  'VHT20_MCS8', 'VHT40_MCS0', 'VHT40_MCS1', 'VHT40_MCS2', 'VHT40_MCS3', 'VHT40_MCS4',
                                  'VHT40_MCS5',
                                  'VHT40_MCS6', 'VHT40_MCS7', 'VHT40_MCS8', 'VHT40_MCS9', 'VHT80_MCS0', 'VHT80_MCS1',
                                  'VHT80_MCS2',
                   ...
                   ratelist_evm_5g = ['6M_EVM', '9M_EVM', '12M_EVM', '18M_EVM', '24M_EVM', '36M_EVM', '48M_EVM',
                                      '54M_EVM',
                                      'HT20_MCS0_EVM', 'HT20_MCS1_EVM', 'HT20_MCS2_EVM', 'HT20_MCS3_EVM',
                                      'HT20_MCS4_EVM',
                                      'HT20_MCS5_EVM', 'HT20_MCS6_EVM', 'HT20_MCS7_EVM', 'HT40_MCS0_EVM',
                                      'HT40_MCS1_EVM',
                                      'HT40_MCS2_EVM', 'HT40_MCS3_EVM', 'HT40_MCS4_EVM', 'HT40_MCS5_EVM',
                                      'HT40_MCS6_EVM',
                                      'HT40_MCS7_EVM', 'VHT20_MCS0_EVM', 'VHT20_MCS1_EVM', 'VHT20_MCS2_EVM',
                                      'VHT20_MCS3_EVM',
                                      'VHT20_MCS4_EVM', 'VHT20_MCS5_EVM', 'VHT20_MCS6_EVM', 'VHT20_MCS7_EVM',
                                      'VHT20_MCS8_EVM',
                                      'VHT40_MCS0_EVM', 'VHT40_MCS1_EVM', 'VHT40_MCS2_EVM', 'VHT40_MCS3_EVM',
                                      'VHT40_MCS4_EVM',
                                      'VHT40_MCS5_EVM', 'VHT40_MCS6_EVM', 'VHT40_MCS7_EVM', 'VHT40_MCS8_EVM',
                                      'VHT40_MCS9_EVM',
                                      'VHT80_MCS0_EVM', 'VHT80_MCS1_EVM', 'VHT80_MCS2_EVM', 'VHT80_MCS3_EVM',
                                      'VHT80_MCS4_EVM',
                                      'VHT80_MCS5_EVM', 'VHT80_MCS6_EVM', 'VHT80_MCS7_EVM', 'VHT80_MCS8_EVM',
                                      'VHT80_MCS9_EVM']
                       ...
                       for cc in range(sheet_5g.max_column):
                           ...
                           for jj in ratelist_5g:
                               if rows_5g[rr][cc].value == jj + '_sens':
                                   exec('sens_%s=%d' % (jj, rows_5g[rrs][cc].value))
                                   break
            ...
            if item == 'TX':
                ...
                #print(power_accuracy_left, power_accuracy_right)
                rate_e = rate_t + '_EVM'
                ...
                if super_mode == '1':
                    ...
                    if avg_power == 'NA' or float(avg_power) > 99.000:
                        ...
                        # power is not nomal
                            ...
                            setups = 2
                            print('Step:', setup)
                            pwra_paras = gain + setup
                            pwrb_paras = gain + setup
                            get_power = []
                            get_delta_power = []
                            c = 1
                            ...
                            while float(avg_power) < power_accuracy_left or float(avg_power) > power_accuracy_right:
                                print('L',power_accuracy_left, avg_power, 'R', power_accuracy_right)
                                ...
                                iq.read_data(targetpower)
                                avg_power, result_evm, result_symbol_clock_error, result_lo_leakage, result_mask = \
                                    iq.get_data(mode, channel, rate, chain, tx_result_name, targetpower, spec_pwr,
                                                pwra_paras, spec_evm, evm_margin, spec_symbol_clock_error,
